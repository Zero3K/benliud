...
//global argument
static unsigned int global_con_limit=100;	//���������ƣ�Ӧ������200

//���ӷ�������
static unsigned int global_try_limit=30;	//Ӧ������10
...
void balence()
{
	...
	int notfinishconsum=0;	//��������
	int finishjobconsum=0;	//��������
...
void settrylimit(int trys)
{
	...
	if(global_try_limit>250) global_try_limit=250; //̫��ķ������Ӳ����ã�û�б�Ҫ
